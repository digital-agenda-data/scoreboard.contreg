                                ...
                                <div class="scb-content">
                                    <div id="boxes-box-haveyoursaybox" class="boxes-box">
                                        <div class="boxes-box-content">
                                            <p><a href="http://daa.ec.europa.eu/"><img border="0" src="${pageContext.request.contextPath}/images/dae-button.png" alt="Have your say on the online engagement platform."/></a></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
