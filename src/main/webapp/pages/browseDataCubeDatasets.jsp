    ...
    <div id="importDialog" title="Import datasets">
        <stripes:form beanclass="${actionBean['class'].name}" method="post">
            ...
            <table>
                ...
                <tr id="catalogRow">
                    <td>
                        <label for="selCatalog" class="question">Target catalog:</label>
                    </td>
                    <td>
                        ...
                        </stripes:select><span style="padding-left:10px;font-size:0.8em">(catalog in spreadsheet file takes precedence if specified)</span>
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
