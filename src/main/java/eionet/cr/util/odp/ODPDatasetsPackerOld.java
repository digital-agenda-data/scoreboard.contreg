 ...
 * @author Jaanus
 */
public class ODPDatasetsPackerOld {

    /** Static logger for this class. */
    private static final Logger LOGGER = Logger.getLogger(ODPDatasetsPackerOld.class);
     ...
     * @param odpAction
     */
    public ODPDatasetsPackerOld(List<String> datasetUris, ODPAction odpAction) {
     ...
     * @param odpAction
     */
    public ODPDatasetsPackerOld(String datasetUri, List<String> indicatorUris, ODPAction odpAction) {
