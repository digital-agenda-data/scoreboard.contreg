...
public class ObjectTypes {
    ...
    private static ObjectType createObservationType() {
        ...
        // Indicator.
        property = new ObjectProperty("http://semantic.digital-agenda-data.eu/def/property/indicator", "indicator",
                "indicator", ObjectProperty.Range.RESOURCE);
        ...
        // Breakdown.
        property = new ObjectProperty("http://semantic.digital-agenda-data.eu/def/property/breakdown", "breakdown",
                "breakdown", ObjectProperty.Range.RESOURCE);
        ...
        // Reference area.
        property = new ObjectProperty("http://semantic.digital-agenda-data.eu/def/property/ref-area", "refArea",
                "ref-area", ObjectProperty.Range.RESOURCE);
        ...
        // Observed value.
        property = new ObjectProperty("http://purl.org/linked-data/sdmx/2009/measure#obsValue", "obsValue",
                "obsValue", ObjectProperty.Range.LITERAL);
